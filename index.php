...
<svg style="display:none" aria-hidden="true">
  ...
  <symbol id="icon-coffee" viewBox="0 0 24 24">
    ...
    <path d="M7.5 2.5c-.7 1-.7 1.8 0 2.8M11.5 2.5c-.7 1-.7 1.8 0 2.8" fill="none"
          stroke="currentColor" stroke-width="1.6" stroke-linecap="round" opacity=".65"/>
  </symbol>
</svg>

<a class="skip-link" href="#generator"><?= e('nav.skip') ?></a>
  ...
  <div class="wrap">
    ...
    <nav class="lang-switch" aria-label="<?= e('nav.language') ?>">
      <?php foreach (I18n::available() as $l): ?>
        <a href="?lang=<?= LightHours\h($l) ?>" title="<?= LightHours\h(I18n::nativeName($l)) ?>"<?= $l === $lang ? ' aria-current="true"' : '' ?>><?= strtoupper(LightHours\h($l)) ?></a>
      <?php endforeach; ?>
    </nav>
    </div>
  </div>
